...
public class Amphibian extends Animal
{
	...
	public Amphibian(int Age, String Consevervation_status, String Diet, boolean Flight, String Habit, boolean healthy, String Last_Checkup, int Lifespan, String Location, String Name, double Weight, int NumberOfLegs){
