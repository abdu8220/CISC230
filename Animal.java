...
public class Animal
{
	 ...
	 */
	public Animal(String Name, int Age,String Consevervation_status,String Diet,boolean Flight,String Habit
	,boolean Healthy,String Last_Checkup,int Lifespan,String Location,int Weight){
		this.Age = Age;
	...
	public String toString(){
		...
		temp += "Average Lifespan:" + getLife() + "years.\n";
		temp += "Location in Zoo: " + getLoc() + ".\n";
		temp += "Weight:" + getWeight() + "lbs.\n";
		return temp;
	}
}